...
class Name(Field):
    def validate(self, value):
        # Можна реалізувати валідацію імені, якщо потрібно
        pass


class Address(Field):
    def validate(self, value):
        # Можна реалізувати валідацію адреси, якщо потрібно
        pass
...
class Phone(Field):
    def validate(self, value):
        ...
        if value.isdigit() and right_len:
            pass # Не викидаємо PhoneException, оскільки тепер валідація відбувається в базовому класі
